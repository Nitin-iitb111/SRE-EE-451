...
def extend_cfg(cfg):
    ...
    cfg.TRAINER.DAMP = CN()
    cfg.TRAINER.DAMP.N_CTX = 16  # number of context vectors
    cfg.TRAINER.DAMP.N_CLS = 2 # number of class vectors
    cfg.TRAINER.DAMP.CSC = False  # class-specific context
    cfg.TRAINER.DAMP.PREC = "fp16"  # fp16, fp32, amp
